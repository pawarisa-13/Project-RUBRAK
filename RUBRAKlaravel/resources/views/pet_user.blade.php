...
<body>
@if (session('success'))
    <div class="popup" id="preem-popup">
        <div class="popup-content">
            <p>{{ session('success') }}</p>
            <button class="preem"onclick="document.getElementById('preem-popup').style.display='none'">ปิด</button>
        </div>
    </div>
 @endif
    <header>
    ...
    <div class="pet-container">
        ...
        <div class="pet-card">
            ...
            <button class="adopt-btn" ><a style="text-decoration: none ; color:aliceblue;"  href="{{ route('req.view', $pet->pet_id) }}">Send a request</a></button>
        </div>
